...
$string['addarandomquestion'] = 'use recommender system';
$string['addarandomquestion_help'] = 'When an RS provided question is added, it results in a question from the category being chosen by recommender system and then inserted into the quiz. This means that student with different skills will get different questions.';
$string['addarandomselectedquestion'] = 'Add an RS provided question ...';
...
$string['addrandom'] = 'Add {$a} RS provided questions';
$string['addrandomfromcategory'] = 'Add RS provided questions from category:';
$string['addrandomquestion'] = 'Add RS provided question';
$string['addarandomquestion_help'] = 'When an RS provided question is added, it results in a randomly-chosen question from the category being inserted into the quiz. This means that different students are likely to get a different selection of questions, and when a quiz allows multiple attempts then each attempt is likely to contain a new selection of questions.';
$string['addrandomquestionatend'] = 'Add a recommender system provided question at the end';
$string['addrandomquestiontopage'] = 'Add an RS provided question to page {$a}';
$string['addrandomquestiontoquiz'] = 'Add an RS provided question to quiz {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'RS provided questions';
...
$string['cannotinsertrandomquestion'] = 'Could not insert new RS provided question!';
...
$string['createcategoryandaddrandomquestion'] = 'Create category and add RS provided question';
...
$string['invalidrandomslot'] = 'Invalid RS provided question slot id.';
...
$string['random'] = 'RS provided question';
$string['randomcreate'] = 'Create random questions';
$string['randomediting'] = 'Editing an RS provided question';
$string['randomfromcategory'] = 'Random question from category:';
$string['randomfromexistingcategory'] = 'RS provided question from an existing category';
$string['randomfromunavailabletag'] = '{$a} (unavailable)';
$string['randomnumber'] = 'Number of RS generated questions';
$string['randomnosubcat'] = 'Questions from this category only, not its subcategories.';
$string['randomquestion'] = 'RS provided question';
$string['randomquestion_help'] = 'An RS provided question is a way of inserting a Recommender System provided question.';
...
The provided questions will be selected from the questions that have all these tags.';
$string['randomquestionusinganewcategory'] = 'RS provided question using a new category';
